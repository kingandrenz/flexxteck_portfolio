export default function Hero() {
  return (
    <section id="hero" className="section-padding text-center min-h-screen flex items-center justify-center bg-gradient-radial">
      <div>
        <img
          src="/flexteck.png"
        ...
        <p className="text-xl sm:text-3xl text-slate-300 mb-8 font-light">
          A Passionate <span className="font-bold text-indigo-300">Full-Stack MERN Developer</span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href="#projects" className="bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-8 rounded-lg shadow-lg">
            View My Work
          </a>
          <a href="#contact" className="bg-slate-700 hover:bg-slate-600 text-slate-200 py-3 px-8 rounded-lg shadow-lg">
            Get In Touch
          </a>
        </div>
      </div>
